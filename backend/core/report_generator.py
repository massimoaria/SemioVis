...
def _build_pdf(image_id: str, results: dict, output_path: Path) -> Path:
    ...
    # 7. Reference
    # ------------------------------------------------------------------
    story.append(Paragraph("Reference", styles["heading1"]))
    story.append(_section_separator())
    story.append(Paragraph(
    ...
    story.append(Paragraph(
        "Report generated by SemioVis — https://github.com/semiovis",
        styles["footer"],
    ))
...
def _build_docx(image_id: str, results: dict, output_path: Path) -> Path:
    ...
    para = doc.add_paragraph("Report generated by SemioVis")
...
<div class="footer">Report generated by SemioVis</div>
</body>
</html>
"""
